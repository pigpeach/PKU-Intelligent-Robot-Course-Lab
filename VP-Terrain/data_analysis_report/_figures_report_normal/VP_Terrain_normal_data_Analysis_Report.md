...
| 形状 | `(2126,)` |
| 数据类型 | `int64` |
| 起始时间 | 2024-03-29 10:22:51 |
| 结束时间 | 2024-04-19 10:52:18 |
| 采集跨度 | 21 天 |
...
| 类别ID | 类别名称 | 样本数量 | 占比 |
|--------|----------|----------|------|
| 0 | Asphalt (沥青) | 307 | 14.44% |
| 1 | Grass (草地) | 391 | 18.39% |
| 2 | Concrete (水泥) | 340 | 15.99% |
| 3 | Brick (砖路) | 394 | 18.53% |
| 4 | Board (地板) | 189 | 8.89% |
| 5 | Synthetic (塑胶) | 348 | 16.37% |
| 6 | Sand (沙地) | 157 | 7.38% |
...
| 指标 | 值 | 说明 |
|------|-----|------|
| 最多样本类别 | Brick (394) | 样本最充足的类别 |
| 最少样本类别 | Sand (157) | 样本最稀缺的类别 |
| 不平衡比率 | **2.51** | 最大/最小样本数比值 |

**解读**:
- 不平衡比率 2.51 表示样本最多的类别是样本最少类别的 2.51 倍
...
| 类别 | 亮度均值 | 亮度标准差 |
|------|----------|------------|
| Asphalt | 0.6991 | 0.1159 |
| Grass | 0.5480 | 0.1144 |
| Concrete | 0.5684 | 0.1335 |
| Brick | 0.5780 | 0.1277 |
| Board | 0.6388 | 0.0726 |
| Synthetic | 0.6607 | 0.0419 |
| Sand | 0.6756 | 0.0800 |
...
| 通道 | 均值 | 标准差 | 最小值 | 最大值 |
|------|------|--------|--------|--------|
| Acc_X | 1189.0930 | 77.6265 | 49.9361 | 1610.7257 |
| Acc_Y | 1183.7802 | 75.4687 | 130.1946 | 1600.6611 |
| Acc_Z | -0.0215 | 5.5359 | -39.0486 | 31.9886 |
| Gyro_X | 0.0260 | 3.0729 | -26.2140 | 29.5324 |
| Gyro_Y | 0.0342 | 3.7254 | -29.6536 | 29.6406 |
| Gyro_Z | 0.0008 | 0.0546 | -0.4273 | 0.3798 |
| Wheel_L | -0.0156 | 0.0675 | -0.4142 | 0.3908 |
| Wheel_R | 0.9991 | 0.0754 | 0.5491 | 1.6798 |
