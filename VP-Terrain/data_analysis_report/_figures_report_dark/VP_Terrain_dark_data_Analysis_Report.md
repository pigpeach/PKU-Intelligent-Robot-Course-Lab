...
| 形状 | `(4274,)` |
| 数据类型 | `int64` |
| 起始时间 | 2024-04-11 21:03:45 |
| 结束时间 | 2024-04-18 23:42:50 |
| 采集跨度 | 7 天 |
...
| 类别ID | 类别名称 | 样本数量 | 占比 |
|--------|----------|----------|------|
| 0 | Asphalt (沥青) | 1131 | 26.46% |
| 1 | Grass (草地) | 433 | 10.13% |
| 2 | Concrete (水泥) | 536 | 12.54% |
| 3 | Brick (砖路) | 523 | 12.24% |
| 4 | Board (地板) | 411 | 9.62% |
| 5 | Synthetic (塑胶) | 892 | 20.87% |
| 6 | Sand (沙地) | 348 | 8.14% |
...
| 指标 | 值 | 说明 |
|------|-----|------|
| 最多样本类别 | Asphalt (1131) | 样本最充足的类别 |
| 最少样本类别 | Sand (348) | 样本最稀缺的类别 |
| 不平衡比率 | **3.25** | 最大/最小样本数比值 |

**解读**:
- 不平衡比率 3.25 表示样本最多的类别是样本最少类别的 3.25 倍
...
| 类别 | 亮度均值 | 亮度标准差 |
|------|----------|------------|
| Asphalt | 0.0453 | 0.0195 |
| Grass | 0.0254 | 0.0050 |
| Concrete | 0.0104 | 0.0086 |
| Brick | 0.0481 | 0.0038 |
| Board | 0.0456 | 0.0028 |
| Synthetic | 0.0259 | 0.0262 |
| Sand | 0.0960 | 0.0707 |
...
| 通道 | 均值 | 标准差 | 最小值 | 最大值 |
|------|------|--------|--------|--------|
| Acc_X | 1189.3074 | 70.3797 | -9.9844 | 1550.4312 |
| Acc_Y | 1182.3784 | 70.0230 | 129.8140 | 1602.8082 |
| Acc_Z | -0.0168 | 4.6463 | -50.8359 | 28.0535 |
| Gyro_X | 0.0054 | 2.5598 | -25.9691 | 27.6066 |
| Gyro_Y | 0.0203 | 2.6808 | -29.9383 | 30.5790 |
| Gyro_Z | 0.0000 | 0.0473 | -0.4477 | 0.4034 |
| Wheel_L | -0.0151 | 0.0575 | -0.4617 | 0.3481 |
| Wheel_R | 0.9992 | 0.0631 | 0.4862 | 1.7289 |
